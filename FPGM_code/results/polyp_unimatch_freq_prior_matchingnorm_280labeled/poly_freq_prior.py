...
parser.add_argument('--labeled-id-path', type=str, default='/home/wth/My_codes/SSL_MIS_Exps/polyp/20%_labeled.txt')
parser.add_argument('--unlabeled-id-path', type=str, default='/home/wth/My_codes/SSL_MIS_Exps/polyp/20%_unlabeled.txt')
...
if __name__ == '__main__':
    snapshot_path = "/home/wth/My_codes/SSL_MIS_Exps/Freq_adaptive_modulation/results/polyp_{}_{}labeled/".format('unimatch_freq_prior_matchingnorm_mix', 280)
